...
.containerClass {overflow:hidden;margin:23px auto 20px;text-align:center;}
.containerClass li {display:inline-block;width:25px;height:25px;margin:0 2px;text-align:center;border:1px solid #c5c5c5;text-decoration:none;line-height:25px;cursor:pointer}
.containerClass li.active {background:#c5c5c5}
.containerClass li a {display:block;width:25px;height:25px}
